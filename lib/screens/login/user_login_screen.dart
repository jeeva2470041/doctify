          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                const SizedBox(height: 20),
                Center(child: Container(width: 80, height: 80, decoration: BoxDecoration(gradient: const LinearGradient(colors: [Color(0xFF00B4D8), Color(0xFF48CAE4)]), borderRadius: BorderRadius.circular(22), boxShadow: [BoxShadow(color: const Color(0xFF00B4D8).withOpacity(0.3), blurRadius: 15, offset: const Offset(0, 6))]), child: const Icon(Icons.person_rounded, size: 40, color: Colors.white))),
                const SizedBox(height: 30),
                const Center(child: Text('User Login', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Color(0xFF1A1A2E)))),
                const SizedBox(height: 8),
                Center(child: Text('Sign in to browse doctors', style: TextStyle(fontSize: 14, color: Colors.grey.shade500))),
                ...
                const SizedBox(height: 20),
                Center(child: GestureDetector(onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const UserRegisterScreen())), child: RichText(text: TextSpan(text: "Don't have an account? ", style: TextStyle(color: Colors.grey.shade500, fontSize: 14), children: const [TextSpan(text: 'Register', style: TextStyle(color: Color(0xFF0077B6), fontWeight: FontWeight.bold))])))),
                const SizedBox(height: 20),
                Container(width: double.infinity, padding: const EdgeInsets.all(16), decoration: BoxDecoration(color: const Color(0xFFF0F8FF), borderRadius: BorderRadius.circular(12), border: Border.all(color: const Color(0xFF00B4D8).withOpacity(0.2))),
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [const Row(children: [Icon(Icons.info_outline, size: 16, color: Color(0xFF00B4D8)), SizedBox(width: 6), Text('Demo Credentials', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFF00B4D8)))]), const SizedBox(height: 8), Text('Email: user@test.com\nPassword: 123456', style: TextStyle(fontSize: 12, color: Colors.grey.shade600, height: 1.5))])),
                const SizedBox(height: 30),
              ]),
            ),
          ),
